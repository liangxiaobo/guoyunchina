	...
	<div class="container">
		...
		<div id="primary" class="content-area">
			...
			<?php
			    ...
			    query_posts( 'showposts=100&cat=5,6' );
...
<div style="padding:10px 0;border-bottom:1px solid rgba(0, 0, 0, 0.05);"><a href="/?page_id=153" style="color:#808080;">行业讯息</a></div>
